          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block m-0 p-0">
                ...
                <li>
                  <a href="konsul.php" class="nav-link">Uji Sistem</a>
                </li>
                <li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Hasil Perhitungan Electre</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Hasil Perhitungan Topsis</a>
                  </li>
                </ul>
...
foreach($data as $nama=>$krit){
  (++$i);
  $V[$i] = $dmin_h[$i-1]/($dmin_h[$i-1]+$dplus_h[$i-1]);
}
foreach ($V as $key => $value) {
  $hasil2[$alternatif[$key]] = round($value, 2);
}
arsort($hasil2);
?>
...
<div class="row ">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="header">
        Nilai Preferensi(V<sub>i</sub>)<br>
        (Rekomendasi Tanaman)
      </div>
      <div class="body table-responsive">
        <table class="table table-bordered">
          ...
          <tbody>
            <?php $no = 1; foreach ($hasil2 as $key => $value) : ?>
              <tr>
                <td><?= $no++ ?></td>
                <td><?= $key ?></td>
                <td><?= $value ?></td>
