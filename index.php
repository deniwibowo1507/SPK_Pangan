          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="konsul.php" class="nav-link">Uji Sistem</a></li>
                <li><a href="history.php" class="nav-link">Riwayat</a></li>
              </ul>
            </nav>
          </div>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  ...
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">Untuk Pengunjung selain Admin silahkan klik Tab Konsul</p>
