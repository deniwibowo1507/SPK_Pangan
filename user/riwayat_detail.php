...
$get_data   = "SELECT tb_laporan.*, tb_member.nama, tb_member.no_hp, tb_member.alamat, tb_lokasi.nama_lokasi FROM tb_laporan INNER JOIN tb_lokasi ON tb_laporan.id_lokasi = tb_lokasi.id_lokasi INNER JOIN tb_member ON tb_laporan.id_user = tb_member.id_user WHERE id_laporan = '$id_laporan'";
    ...
    <div class="main-content container-fluid">
      ...
      <section class="section">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Electre</a>
          </li>
          <li class="nav-item">
