    ...
    <div class="site-section">
      <div class="container">
        <div class="row mt-5 justify-content-center">
          <div class="col-lg-12">
            <h4 class="text-center" style="color: #000">Hasil Perhitungan</h4>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Hasil Perhitungan Electre</a>
                  </li>
                  <li class="nav-item">
